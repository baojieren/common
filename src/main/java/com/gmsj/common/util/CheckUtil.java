...
public class CheckUtil {
    ...
    private static final int CHECK_ERR_CODE_START = 2000;
     ...
     */
    public static void isEmpty(String paramName, String paramValue) throws BaseRuntimeException {
     ...
     * @param paramValue 参数值
     */
    public static void isEmpty(String paramName, Object paramValue) throws BaseRuntimeException {
        if (paramValue == null) {
            throw new BaseRuntimeException(
                    new BaseError(CHECK_ERR_CODE_START + 1, "【" + paramName + "】不能为null")
            );
        }
    }
